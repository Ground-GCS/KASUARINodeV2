 ...
 */
 ...
 //-6.970484, 107.629704
 //-6.975553, 107.630305
let  homeLatitude = -6.976117,
	   homeLongitude = 107.630233;
...
try {
  ...
  antennaPort = serial.connectSerial(antennaPortNum, 9600);
  ...
  // data event for serial data incoming
    ...
    //console.log(data);
      ...
      //   writeAntennaTracker(azimuth, elevation,antennaPort);
      // }
